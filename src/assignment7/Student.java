...
public class Student implements Iterable<CourseReport>, Serializable {
    ...
    public Student(Student other) {
        if (other == null) {
            ...
            this.id = 0;
            this.courseReports = null;
        } else if (other.courseReports != null) {
    ...
    public double getWeightedAverage() {
        double sum = 0;
        double totalPoints = 0;
        // Ensure there are course reports
        ...
        if (totalPoints == 0 || courseReports.length == 0) {
            throw new AverageCalcException(this.name);
        }
        // Ensure the weighted average is between 0 and 100
    ...
    // Instance fields
    private String name;
    private transient int id; // This field will not be saved
